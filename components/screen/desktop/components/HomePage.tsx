                ...
                <div className='h-20 flex items-center justify-between px-8 border-b border-gray-100'>
                    <div className='flex items-center gap-10'>
                        <div className='flex items-center gap-3'>
                            ...
                            <div>
                                <h1 className='font-bold text-2xl text-gray-900 tracking-tight'>construco</h1>
                        ...
                        <nav className='flex items-center gap-1'>
                            {[
                                ...
                                <button
                                    key={item.name}
                                    className={`px-5 py-2.5 rounded-xl text-sm font-medium transition-all flex items-center gap-1.5 ${item.active
                    ...
                    <div className='grid grid-cols-2 gap-6 mb-10'>
                        ...
                        <div className='bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 rounded-3xl p-10 flex items-center justify-between overflow-hidden relative'>
                            ...
                            <div className='relative z-10'>
                                ...
                                <h3 className='text-4xl font-bold text-white mt-3'>Sell on construco</h3>
